...
## Purpose
NestJS module that provides dependency injection for Puppeteer (headless Chrome). It follows NestJS patterns for dynamic modules with sync/async configuration.
